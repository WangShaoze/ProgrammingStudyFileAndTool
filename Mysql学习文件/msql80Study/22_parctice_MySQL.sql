...
#创建数据库时指名字符集
CREATE DATABASE IF NOT EXISTS datest12 CHARACTER SET 'utf8';
SHOW CREATE DATABASE datest12;
...
INSERT INTO test_int3  # 失败
VALUES(-2412321);  -- Out of range value for column 'f1' at row 1
...
SELECT SUM(f1)   # 结果应为：1.1
FROM test_double2; # but :  1.0999999999999999  存在精度损失
